...
public class Monster {
	...
	public Monster GetMonster(String name, String map) {
		...
		if(map.equals("Streets305")) {
			...
			//PoyoBat
			if(name.equals("poyobatA")){
				mobReturn.NAME = "poyobay";//Name
				mobReturn.HP = "350";//HP
				mobReturn.MP = "25";//MP
				mobReturn.HPMAX = "350"; //HPMAX
		...
		if(map.equals("Forest")) {
			//Bee
			if(name.equals("beeA")){
				mobReturn.NAME = "beeA";//Name
				mobReturn.HP = "90";//HP
				mobReturn.MP = "10";//MP
				mobReturn.HPMAX = "90"; //HPMAX
				mobReturn.MPMAX = "10"; //MPMAX
				mobReturn.PX = "54";//PX
				mobReturn.PY = "-104";//PY
				mobReturn.SIDE = "left"; //SIDE
				...
				mobReturn.BATTLE = "no"; //BATTLE
				mobReturn.TARGET = "none";
				mobReturn.EXP = "30"; //EXP
				mobReturn.LEVEL = "2"; //LEVEL
				mobReturn.MONEY = "0"; //MONEY
				mobReturn.SKILL1 = "none"; //SKILL1
				mobReturn.SKILL2 = "none"; //SKILL2
				mobReturn.AUTOATK = "180"; //AUTOATK
				mobReturn.AUTOSKILL1 = "5"; //AUTOSKILL1
				mobReturn.AUTOSKILL2 = "0"; //AUTOSKILL2
				mobReturn.AUTOATKBASE = "180";
				mobReturn.ID = "A2"; //ID
				mobReturn.AGRESSIVE = "no";
				mobReturn.RESPAWN = "120";
				mobReturn.RESPAWNMAX = "120";
				mobReturn.FRAME = "1";
				mobReturn.FREQUENCY = "10";
			...
			if(name.equals("willowA")){
				mobReturn.NAME = "willowA";//Name
				mobReturn.HP = "220";//HP
				mobReturn.MP = "20";//MP
				mobReturn.HPMAX = "220"; //HPMAX
				mobReturn.MPMAX = "20"; //MPMAX
				mobReturn.PX = "54";//PX
				mobReturn.PY = "-104";//PY
				mobReturn.SIDE = "left"; //SIDE
				mobReturn.HEIGHT = "20"; // Height
				...
				mobReturn.DEF = "10";//DEF
				mobReturn.RESF = "0";//RESF
				mobReturn.RESA = "0"; //RESA
				mobReturn.RESI = "0"; //RESI
				mobReturn.BATTLE = "no"; //BATTLE
				mobReturn.TARGET = "none";
				mobReturn.EXP = "60"; //EXP
				mobReturn.LEVEL = "4"; //LEVEL
				mobReturn.MONEY = "0"; //MONEY
				mobReturn.SKILL1 = "none"; //SKILL1
				mobReturn.SKILL2 = "none"; //SKILL2
				mobReturn.AUTOATK = "180"; //AUTOATK
